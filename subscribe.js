...
Event.listen( 'house', fn1 = function ( price ){
    console.log( '小红得知价格----' + price )
})
Event.listen( 'house', fn2 = function ( price ){
    console.log( '小敏得知价格----' + price )
})

Event.remove( 'house', fn2 )
setTimeout( ()=>{
    Event.trigger( 'house', 7000 )
},2000 )